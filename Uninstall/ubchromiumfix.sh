...
echo "deb http://ppa.launchpad.net/canonical-chromium-builds/stage/ubuntu bionic main 
deb-src http://ppa.launchpad.net/canonical-chromium-builds/stage/ubuntu bionic main " >> /etc/apt/sources.list
