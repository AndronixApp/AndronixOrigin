...
rm -rf $folder/etc/resolv.conf && echo "namserver 1.1.1.1" > $folder/etc/resolv.conf
echo "pacman-mirrors -g -c The_Netherlands && pacman -Syyuu --noconfirm" > $folder/root/.bash_profile
