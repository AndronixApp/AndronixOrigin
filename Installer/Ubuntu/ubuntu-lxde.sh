...
wget --tries=20 https://raw.githubusercontent.com/ultrahacx/AndronixOrigin/master/APT/XFCE4/lxde_de.sh -P $folder/root
clear
...
if [ ! -f /usr/local/bin/vncserver-start ]; then
    wget --tries=20  https://raw.githubusercontent.com/ultrahacx/AndronixOrigin/master/APT/LXDE/vncserver-start
    wget --tries=20 https://raw.githubusercontent.com/ultrahacx/AndronixOrigin/master/APT/LXDE/vncserver-stop
fi
