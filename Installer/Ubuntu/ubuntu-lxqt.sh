...
wget --tries=20 https://raw.githubusercontent.com/ultrahacx/AndronixOrigin/master/APT/XFCE4/lxqt_de.sh -P $folder/root
clear
...
if [ ! -f /usr/local/bin/vncserver-start ]; then
    wget --tries=20  https://raw.githubusercontent.com/ultrahacx/AndronixOrigin/master/APT/LXQT/vncserver-start
    wget --tries=20 https://raw.githubusercontent.com/ultrahacx/AndronixOrigin/master/APT/LXQT/vncserver-stop
fi
